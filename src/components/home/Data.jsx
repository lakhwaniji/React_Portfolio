...
const Data=()=>{
    return(
        <div className="home__data">
            ...
            <p className="home__description">Hello and welcome to my portfolio website! I'm Lovelakhwani, a dedicated third-year student pursuing Btech Computer Science Engineering specializing in IoT (Internet of Things) and IS (Information Systems), I invite you to explore my projects and insights as I navigate the dynamic intersection of engineering and digital systems.</p>
